...
import winner3 from "../../../assets/kumar_rohit_chandra.png";
...
const testimonialData = [
  ...
  {
    winnerName: "Kumar Rohit Chandra",
    winnerAs: "🏆 Second Runner Up, Palette'20",
    winnerPic: winner3,
    winnerQuote:
      "Palette '20 was an essential challenge that helped me figure out my design process. With a tight deadline and solid constraints, the designathon offers a clear path to tread. The crazy problem statement lent me the license to not be serious. So the whole project was a fun process hustling to reach the right output. During the event, I connected with young like-minded designers. Later, the project I created here helped me grab the internship I was looking forward to. Total win-win!",
  },
];
